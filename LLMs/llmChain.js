...
Você terá acesso a um contexto externo (RAG) que fornece detalhes da view, colunas, tipos de dados e valores possíveis.
...
- **Não use FETCH FIRST ... ROW ONLY.**  
- **Para retornar 1 ou n registros ordenados (ex.: “os 5 maiores”), use subselect.**  
  - Ordene a subquery usando ORDER BY ...,  
  - E na query externa aplique WHERE ROWNUM <= n.  
  - **Não** faça ORDER BY ... WHERE ROWNUM <= x na mesma SELECT (gera ORA-00933).
